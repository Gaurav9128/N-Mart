    ...
    const AddProduct = () => {
        ...
        const generateSearchKeywords = (title, brand, category, tags) => {
            ...
            const words = [
                ...
                ...(category || "").toLowerCase().trim().split(" "),
        ...
        transaction.set(docRef, {
            ...validatedProduct,      // ✅ Spread existing validated product
            searchKeywords: searchKeywords,  // ✅ Add search keywords properly
            createdAt: serverTimestamp()     // ✅ Add timestamp properly
        });
